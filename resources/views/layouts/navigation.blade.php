            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->hasAnyRole(['glavni_admin', 'administrator_klinike']))
                        ...
                        <x-nav-link :href="route('findings.index')" :active="request()->routeIs('findings.*') || request()->routeIs('finding-categories.*')">
                            {{ __('Nalazi') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->hasAnyRole(['glavni_admin', 'administrator_klinike']))
                ...
                <x-responsive-nav-link :href="route('findings.index')" :active="request()->routeIs('findings.*') || request()->routeIs('finding-categories.*')">
                    {{ __('Nalazi') }}
                </x-responsive-nav-link>
